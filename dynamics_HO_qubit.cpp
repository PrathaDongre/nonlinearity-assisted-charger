...
int main()
{
ofstream out("energy_g1_0.1_g2_0_F_0.1.dat");
ofstream ergo_out("ergotropy_g1_0.1_g2_0_F_0.1.dat");
...
cx_vec e_n; cx_mat ket_e_n; // eigenvals and vects of H_B
eig_gen(e_n,ket_e_n, Hb);
