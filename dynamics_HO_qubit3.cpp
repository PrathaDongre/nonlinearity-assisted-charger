...
int main()
{
ofstream out("energy_g1_0.1_g2_0.0_F_0.7.dat");
ofstream ergo_out("ergotropy_g1_0.1_g2_0.0_F_0.7.dat");

int N=10; double g1=0.1, g2=0.0, F=0.7, t=300; double w0=1.06;
