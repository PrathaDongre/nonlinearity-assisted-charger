...
int main()
{
ofstream out("energy_nonlin_g1_0.05_g2_0.05_F_1.dat");
ofstream ergo_out("ergotropy_nonlin_g1_0.05_g2_0.05_F_1.dat");

int N=8; double g1=0.05, g2=0.05, F=1, t=100; double w0=1.0;
